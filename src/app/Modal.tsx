...
import { AiFillDatabase, AiOutlineUsergroupDelete, AiOutlineVerticalAlignBottom, AiOutlineUndo, AiFillBulb, AiTwotoneBug, AiOutlineSave, AiTwotoneEdit } from "react-icons/ai";
            ...
            case 'div3':
                return <div>
                    <div className='flex justify-between'>
                        ...
                        <div><button className='p-7' onClick={handleEditClick}><AiTwotoneEdit size={25} /></button></div></div>
                    <div className="flex justify-center flex-col items-center">
                        <div><AiOutlineSave size={300} color='#C9BCE3' /></div>
                    ...
                    <div className="dashboard p-5">
                        <div className="sidebar"> <div className="menu">
                            <div className='bg-slate-50  w-56 sidebar grid grid-rows-4'>
                                <div className='p-3.5 items-center flex gap-1 role1' onClick={() => handleButtonClick('div1')} style={{ backgroundColor: selectedDiv === 'div1' ? 'antiquewhite' : '' }}><AiFillDatabase size={30} />Job Description</div>
                                <div className='p-3.5 items-center flex gap-1 role1' onClick={() => handleButtonClick('div2')} style={{ backgroundColor: selectedDiv === 'div2' ? 'antiquewhite' : '' }}><AiOutlineUsergroupDelete size={30} />Company</div>
                                <div className='p-3.5 items-center flex gap-1 role1' onClick={() => handleButtonClick('div3')} style={{ backgroundColor: selectedDiv === 'div3' ? 'antiquewhite' : '' }}><AiOutlineVerticalAlignBottom size={30} />Note</div>
                                <div className='p-3.5 items-center flex gap-1 role1' onClick={() => handleButtonClick('div4')} style={{ backgroundColor: selectedDiv === 'div4' ? 'antiquewhite' : '' }}><AiOutlineUndo size={30} />Networking</div>
                            </div>
                        </div></div>
